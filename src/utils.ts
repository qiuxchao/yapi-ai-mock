...
/** get GPT Prompt */
export const getPrompt = (input: string) => indent`
Example:
Input: '[{"type":"object","properties":{"code":{"type":"integer"},"message":{"type":"string"},"data":{"type":"array","items":{"type":"object","properties":{"itemCategoryId":{"type":"number","description":"商品类目 ID"},"itemCateGoryName":{"type":"string","description":"商品类目名称"}},"required":["itemCategoryId","itemCateGoryName"]}}},"$schema":"http://json-schema.org/draft-04/schema#","description":""}]'
Output: '[{"code":200,"message":"success","data|10-20":[{"itemCategoryId|1-100":1,"itemCateGoryName":"@ctitle(2, 5)"}]}]'
Input: '[{"type":"object","properties":{"code":{"type":"integer"},"message":{"type":"string"},"data":{"type":"object","properties":{"contactsName":{"type":"string","description":"联系人名称"},"contactsWxCode":{"type":"string","description":"联系人微信"},"contactsWxImg":{"type":"string","description":"联系人二维码"}},"description":"成功返回结果"}},"$schema":"http://json-schema.org/draft-04/schema#","description":""}, {"type":"object","properties":{"code":{"type":"integer"},"message":{"type":"string"},"data":{"type":"array","items":{"type":"object","properties":{"title":{"type":"string","description":"需求名称"},"createTime":{"type":"object","properties":{},"description":"奖励发放时间"}}},"description":"成功返回结果"}},"description":""}]'
Output: '[{"code":200,"message":"success","data":{"contactsName":"@cname()","contactsWxCode":"@word(5, 10)","contactsWxImg":"@image(\\"200x200\\", \\"#ccc\\", \\"#fff\\", \\"wxQrCode\\")"}},{"code":200,"message":"success","data|10-20":[{"title":"@ctitle(5, 10)","createTime":"@datetime"}]}]'

Prompt:
Input: '[{"type":"object","properties":{"code":{"type":"integer"},"message":{"type":"string"},"data":{"type":"object","properties":{"list":{"type":"array","items":{"type":"object","properties":{"id":{"type":"number","description":"主键id"},"orderNo":{"type":"string","description":"订单编号"},"parentOrderNo":{"type":"string","description":"父订单编号"},"msgContent":{"type":"string","description":"消息内容"},"itemTitle":{"type":"string","description":"商品标题"},"consigneeName":{"type":"string","description":"收货联系人"},"consigneeMobile":{"type":"string","description":"收货联系手机号"},"consigneeAddress":{"type":"string","description":"收货人地址"},"groupLeaderName":{"type":"string","description":"团长昵称"},"groupLeaderWxGroupRelation":{"type":"string","description":"团长关联群聊"},"companyName":{"type":"string","description":"供应商名称"},"supplierWxGroupRelation":{"type":"string","description":"供应商关联群聊"},"operatorName":{"type":"string","description":"操作人姓名"},"processingStatus":{"type":"number","description":"处理状态(1:未处理,2:已处理)"},"createTime":{"type":"string","description":"创建时间"},"updateTime":{"type":"string","description":"处理时间"}}}},"endPage":{"type":"boolean"},"totalCount":{"type":"number"},"currentPage":{"type":"number"}},"required":["list","currentPage","totalCount","endPage"]}},"description":""}]'
Output: '[{"code":200,"message":"success","data":{"list|10-20":[{"id|1-100":1,"orderNo":"@word(10, 20)","parentOrderNo":"@word(10, 20)","msgContent":"@csentence(10, 20)","itemTitle":"@ctitle(5, 10)","consigneeName":"@cname()","consigneeMobile":"@integer(10000000000, 19999999999)","consigneeAddress":"@county(true)","groupLeaderName":"@cname()","groupLeaderWxGroupRelation":"@word(5, 10)","companyName":"@ctitle(5, 10)","supplierWxGroupRelation":"@word(5, 10)","operatorName":"@cname()","processingStatus|1-2":1,"createTime":"@datetime","updateTime":"@datetime"}],"endPage":true,"totalCount|100-200":100,"currentPage":1}}]'
Input: ${input}
Output: 
`;
